...
from app.core.security import get_current_user, get_current_active_superuser, check_permission
...
async def create_role(
    ...
    if any(role.name.lower() == role_in.name.lower() for role in existing_roles):
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
