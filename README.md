...
Recommended production hardening before deployment:

- Set ENVIRONMENT=production and DEBUG=False
- Use a strong SECRET_KEY
- Lock CORS origins to real domains
...
Add screenshots in a folder such as docs/screenshots and reference them here:
...
- Async API and database patterns
- Role-aware frontend UX
- Data-driven planning features for inventory operations

## Current Known Gaps

- Forgot password flow redirects to login (not implemented)
- Fine-grained backend permission checks can be expanded beyond superuser-only endpoints
- Root and frontend docs can be further polished with screenshots and deployment visuals

## License

Add a LICENSE file (recommended: MIT) before public release.
